...
class DraftRebaseTest {
    ...
    @Test
    fun `changes from git can be merged after draft creation`(): Unit = runBlocking {
        withTimeout(10.minutes) {
            runWithGitRepository { gitUrl ->
                ...
                val createdDraft = draftsApi.createDraftInRepository(
                    createdRepository.id.toString(),
                    DraftConfig(
