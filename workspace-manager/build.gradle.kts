...
dependencies {
    ...
    implementation(libs.jetty9.proxy)
    implementation(libs.jetty9.server)
    implementation(libs.jetty9.servlet)
    implementation(libs.jetty9.websocket.client)
    implementation(libs.jetty9.websocket.server)
    implementation(libs.jetty9.websocket.servlet)
